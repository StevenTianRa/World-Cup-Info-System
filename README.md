...
```
cd existing_repo
git remote add origin https://git.uwaterloo.ca/grxu/cs348group18.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.uwaterloo.ca/grxu/cs348group18/-/settings/integrations)
